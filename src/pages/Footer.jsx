      ...
      <div className="col-xl-4 col-lg-6 wow fadeIn" data-wow-delay=".5s">
        <div className="d-flex bg-light p-3 rounded">
          ...
          <div className="ms-3">
            ...
            <Link className="h5" to="" target="_blank">{t('+966-555-460-00')}</Link>
          </div>
        </div>
      </div>
    ...
    <div className="container pt-5 pb-4">
      <div className="row g-5">
        ...
        <div className="col-lg-3 col-md-6">
          ...
          <div className="text-white mt-4 d-flex flex-column contact-link">
            <a to="#" className="pb-3 text-light border-bottom border-primary"><i className="fas fa-map-marker-alt text-info me-2" /> {t('Malaz, Saudia Arab')}</a>
            <a to="#" className="py-3 text-light border-bottom border-primary"><i className="fas fa-phone-alt text-info me-2" /> {t('+966-555-460-00')}</a>
            <a to="#" className="py-3 text-light border-bottom border-primary"><i className="fas fa-envelope text-info me-2" />{t(' GEC@gmail.com')}</a>
          </div>
        </div>
      </div>
      ...
      <div className="row">
        <div className="col-md-6 text-center text-md-start">
          <span className="text-light"><a href="#" className="text-info"><i className="fas fa-copyright text-info me-2" />{t('Gulf Egyptian Construction Co.')}</a>{t(', All right reserved.')}</span>
        </div>
